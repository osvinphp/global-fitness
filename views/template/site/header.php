...
// echo "<pre>"; print_r($NewHomeMetaData); die;
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
  ...
  <!-- Meta data for new home page end -->
  <?php 
  if(isset($NewHomeMetaData)){  ?>
  <link rel="canonical" href="<?php  if(isset($NewHomeMetaData)){print_r($NewHomeMetaData[0]->CanonicalLink);} ?>" />
  <title><?php
    if(isset($NewHomeMetaData)) {
      print_r($NewHomeMetaData[0]->PageTitle);
    }else{ echo "Global Fitness"; }
    ?></title>
    <meta name="description" content="<?php
    if(isset($NewHomeMetaData))
      { print_r($NewHomeMetaData[0]->MetaDescription); }
    else{ print_r( $description) ; }
    ?>">
    <meta name="keywords" content="<?php 
    if(isset($NewHomeMetaData)){ print_r($NewHomeMetaData[0]->MetaKeywords); }
    elseif(isset($CategoryData)){
      print_r($CategoryData[0]->MetaNameKeywords) ; }
      elseif(isset($detail[0]->MetaCategoryPageKeywords)){
        print_r($detail[0]->MetaCategoryPageKeywords);}
        elseif(isset($keywords)){ print_r($keywords);}
        elseif(isset($detail)){print_r($detail[0]->MetaDetailPageKeywordTag) ; } ?>">
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <meta name="distribution" content="<?php if(isset($NewHomeMetaData)){  print_r($NewHomeMetaData[0]->MetaDistribution) ; } else{
         echo " Global "; }?>">
         <meta name="language" content="<?php if(isset($NewHomeMetaData)){  print_r($NewHomeMetaData[0]->MetaLanguage); }?>">
         <meta name="y_key" content="<?php if(isset($NewHomeMetaData)){  print_r($NewHomeMetaData[0]->MetaY_key); }?>">
         <meta name="twitter:card" content="<?php if(isset($NewHomeMetaData)){print_r($NewHomeMetaData[0]->TwitterCard);} ?>">
         <meta name="twitter:title" content="<?php  if(isset($NewHomeMetaData)){print_r($NewHomeMetaData[0]->TwitterTitle);} ?>">
         <?php  }
         ?>
         <!-- Meta data for new home page end -->
         <title><?php
          if(isset($myprod)) {
            print_r($myprod->MetaPageTitle);
          }elseif(isset($MetaCategoryPageTitle)){ echo $MetaCategoryPageTitle ; }elseif(isset($title)){ echo $title;}
          elseif (isset($detail)) {
            echo $detail[0]->MetaCategoryPageTitle;
          }
          else{ echo "Global Fitness"; }
          ...
          <meta name="description" content="<?php
          if(isset($myprod))
            { print_r($myprod->MetaPageDescription); }
          elseif(isset($CategoryData))
            { print_r($CategoryData[0]->MetaNameDescription);}
          elseif(isset($detail[0]->MetaDetailPageDescriptionTag))
            { print_r($detail[0]->MetaDetailPageDescriptionTag);}
          else if (isset($detail[0]->MetaCategoryPageDescription))
            { print_r($detail[0]->MetaCategoryPageDescription);}
          else{ print_r( $description) ; }
          ?>">
          <meta name="keywords" content="<?php if(isset($myprod)){ print_r($myprod->MetaPageKeywords); }elseif(isset($CategoryData)){
            print_r($CategoryData[0]->MetaNameKeywords) ; }elseif(isset($detail[0]->MetaCategoryPageKeywords)){print_r($detail[0]->MetaCategoryPageKeywords);}
            elseif(isset($keywords)){ print_r($keywords);}
            elseif(isset($detail)){print_r($detail[0]->MetaDetailPageKeywordTag) ; } ?>">
            <meta charset="utf-8">
            <meta http-equiv="X-UA-Compatible" content="IE=edge">
            <meta name="distribution" content="<?php if(isset($CategoryData)){  print_r($CategoryData[0]->MetaNameLanguage) ; } else{
             ...
             if(isset($detail)){
              ?>
              <!-- Twitter Card data -->
              <meta name="twitter:card" content="<?php  if (isset($myprod->TwitterCard)) {
                echo $myprod->TwitterCard;
              }  elseif (isset($detail[0]->TwitterCard)) {
                echo $detail[0]->TwitterCard;
              } else{ echo "product"; } ?>">
              <meta name="twitter:site" content="<?php    if (isset($myprod->TwiiterSite)) {
                echo $myprod->TwiiterSite;
              } elseif(isset($detail[0]->TwitterSite)) {
                echo $detail[0]->TwitterSite;
              } else{ echo "@globalfitnessinc"; } ?>">
              <meta name="twitter:title" content="<?php if(isset($myprod)){}elseif(isset($detail[0]->TwitterTitle)){ print_r($detail[0]->TwitterTitle); }else{ print_r($detail[0]->TwiiterTitle); }
              ?>">
              <meta name="twitter:description" content="<?php  if(isset($myprod)){}else{print_r($detail[0]->TwitterDescription); } ?>">
              <meta name="twitter:image" content="<?php if(isset($myprod)){}elseif(isset($detail[0]->TwitterImage)){ print_r($detail[0]->TwitterImage); }else{ print_r($detail[0]->TwiiterImage); }
              ?>">
              <meta name="twitter:data1" content="<?php  if(isset($myprod)){}else{print_r($detail[0]->TwitterData1);} ?>">
              <meta name="twitter:label1" content="<?php  if(isset($myprod)){}else{print_r($detail[0]->TwitterLabel1);} ?>">
              <meta name="twitter:data2" content="<?php  if(isset($myprod)){}else{print_r($detail[0]->TwitterData2);} ?>">
              <meta name="twitter:label2" content="<?php  if(isset($myprod)){}else{print_r($detail[0]->TwitterLabel2);} ?>">
              <!-- Open Graph data -->
              <meta property="og:url" content="<?php   if (isset($myprod->ogUrl)) {
                echo $myprod->ogUrl;
              }elseif(isset($detail[0]->ogUrl)){print_r($detail[0]->ogUrl);} else{print_r($detail[0]->ogURL); }?>" />
              <meta property="og:title" content="<?php   if (isset($myprod->ogTitle)) {
                echo $myprod->ogTitle;
              }else{  print_r($detail[0]->ogTitle); } ?>" />
              <meta property="og:description" content="<?php  if (isset($myprod->ogDescription)) {
                echo $myprod->ogDescription;
              }else{   print_r($detail[0]->ogDescription); }?>" />
              <meta property="og:image" content="<?php  if(isset($myprod)){}else{print_r($detail[0]->ogImage);} ?>" />
              <meta property="og:type" content="<?php    if (isset($myprod->ogType)) {
                echo $myprod->ogType;
              }else{ print_r($detail[0]->ogType); }?>" />
              <meta property="og:site_name" content="<?php    if (isset($myprod->ogSite_name)) {
                echo $myprod->ogSite_name;
              }elseif(isset($detail[0]->ogSite)){print_r($detail[0]->ogSite);} else{print_r($detail[0]->ogSite_name);  }   ?>" />
              <meta property="og:price:amount" content="<?php  if(isset($myprod)){}else{print_r($detail[0]->Price);} ?>" />
              <meta property="og:price:currency" content="USD" />
              <?php   } ?>


              <?php  if(isset($NewHomeMetaData)) {?>
              <meta name="viewport" content="width=device-width, initial-scale=1">
              <meta name="google-site-verification" content="<?php if(isset($NewHomeMetaData)){print_r($NewHomeMetaData[0]->MetaGoogleSiteVerification);} else{echo 'L2x_VprrPGVutLyM8_7BGD4O1o9O7xKU32R2Tck4LUs';}?>" />
              <meta name="msvalidate.01" content="<?php if(isset($NewHomeMetaData)){print_r($NewHomeMetaData[0]->MetaMSvalidate01);}else{echo 'E599DF9170BF8DC750EAD6418FE9343A';} ?>" />
              <meta name=”alexaVerifyID” content="" />
              <meta name="Author" content="<?php if(isset($NewHomeMetaData)){ print_r($CategoryData[0]->MetaAuthor) ;} ?>">
                <meta property="og:url" content="<?php if (isset($NewHomeMetaData)) {
                  echo $NewHomeMetaData[0]->ogURL;
                }?>" />
                <meta property="og:title" content="<?php   if (isset($NewHomeMetaData)) {
                  echo $NewHomeMetaData[0]->ogTitle;
                }?>" />
                <meta property="og:image" content="<?php if(isset($NewHomeMetaData)){print_r($NewHomeMetaData[0]->ogImage);}?>" />
                <meta property="g:locale" content="<?php if(isset($NewHomeMetaData)){print_r($NewHomeMetaData[0]->ogLocale);}?>" />
                <meta property="og:type" content="<?php if(isset($NewHomeMetaData)){echo $NewHomeMetaData[0]->ogType;} ?>" />
                <meta property="og:site_name" content="<?php if(isset($NewHomeMetaData)){echo $NewHomeMetaData[0]->ogSiteName;}?>" />
                <meta property="og:price:amount" content="<?php  if(isset($myprod)){}else{print_r($detail[0]->Price);} ?>" />
                <meta property="og:price:currency" content="USD" />
                <meta name="p:domain_verify" content="<?php if(isset($NewHomeMetaData)){print_r($NewHomeMetaData[0]->MetaPdomainVerify);}else{echo '854f02f924e0b28ab0649663059a3a04';} ?>" /> 
                <?php  }  ?>
                <script>
                ...
                <script type="text/javascript">
                  (function(a,e,c,f,g,h,b,d){var k={ak:"951974390",cl:"trs0CN_l0nsQ9vP3xQM",autoreplace:"888-991-9991"};a[c]=a[c]||function(){(a[c].q=a[c].q||[]).push(arguments)};a[g]||(a[g]=k.ak);b=e.createElement(h);b.async=1;b.src="//www.gstatic.com/wcm/loader.js";d=e.getElementsByTagName(h)[0];d.parentNode.insertBefore(b,d);a[f]=function(b,d,e){a[c](2,b,k,d,null,new Date,e)};a[f]()})(window,document,"_googWcmImpl","_googWcmGet","_googWcmAk","script");
                </script>
                <!-- Global site tag (gtag.js) - Google AdWords: 951974390 -->
                <script async src="https://www.googletagmanager.com/gtag/js?id=AW-951974390"></script>
                <script>
                  window.dataLayer = window.dataLayer || [];
                  function gtag(){dataLayer.push(arguments);}
                  gtag('js', new Date());

                  gtag('config', 'AW-951974390');
                </script>
                <script>
                  window.addEventListener('load',function() {
                    var timer = setInterval(function() {
                      if(jQuery('.Email_successfull_content_PEnaL p:contains("thank you for getting in touch!")').is(":visible") == true) {
                        gtag('event', 'conversion', {'send_to': 'AW-951974390/IqCvCIbm6XsQ9vP3xQM'});
                        clearInterval(timer);
                      }
                    },1500)
                  })
                ...
                <script type="application/ld+json">
                  {
                    ...
                    "@type": "LocalBusiness",
                    "image": [
                    "https://www.globalfitness.com/images-fitness-equipment-sale/life-fitness-clsx-elliptical-crosstrainer-medium.jpg",
                    "https://www.globalfitness.com/images-fitness-equipment-sale/keiser-m3-bike-medium.jpg",
                    "https://www.globalfitness.com/images-fitness-equipment-sale/global-fitness-used-fitness-equipment-warehouse-large.jpg"
                    ],
                    "@id": "https://www.globalfitness.com",
                    "name": "Global Fitness Equipment",
                    "address": {
                      "@type": "PostalAddress",
                    ...
                    "geo": {
                      "@type": "GeoCoordinates",
                      "latitude": 33.902726,
                      "longitude": -118.306295
                    },
                    "url": "https://www.globalfitness.com/page/contact-us",
                    "telephone": "+13108080888",
                    ...
                    "priceRange": "$ - $$$$",
                    "paymentAccepted": "Amex, Visa, MasterCard, Check, Wire & Cash"
                  }
                },
                "aggregateRating": {
                    ...
                    <div class="content_wrapper">
                      <nav class="navbar navbar-inverse">
                        <div class="collapse navbar-collapse js-navbar-collapse">
                          ...
                          <li><a class="RED_MENU" href="https://sale.globalfitness.com">Shop Sales</a></li>
                        </ul>
                      </div>
                      <!-- /.nav-collapse -->
                    </nav>
                        ...
                        <ul class="nav navbar-nav navbar-right">
                          ...
                          <li class="dropdown">
                            ...
                            <ul class="dropdown-menu Links_DROPdoWn">
                              <li><a href="<?php echo base_url('site/myorders'); ?>">My orders</a></li>
                              <li><a href="">Support</a></li>
