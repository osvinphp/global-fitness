...
<head>
 ...
 <title><?php if(isset($title)){ echo $title ; }elseif(isset($CollapsiblePanelTitle)){ echo $CollapsiblePanelTitle;}else{ echo "Global Fitness"; }  ?></title>
...
<link href="<?php echo base_url('public/assets/css/acc-wizard.min.css'); ?>" rel="stylesheet">
<!-- checkoutheader -->
    ...
    <nav id="ac-globalnav" class="js no-touch">
      <div class="ac-gn-content">
        ...
        <ul class="ac-gn-list">
          ...
          foreach($menu as $cat){
            ?>
            <li class="ac-gn-item ac-gn-item-menu "><a  class="ac-gn-link"  title="<?php echo $cat->LinkTitleTag; ?>" href="<?php echo $cat->ConanicalURL ?>"><span ><?php echo $cat->MenuName; ?></span></a></li>
            <?php
          }
          ?>
                                  ...
                                  <ul class="ubermenu-submenu ubermenu-submenu-id-189 ubermenu-submenu-type-auto ubermenu-submenu-type-stack FIFTy_WTH mega_Custom">
                                    ...
                                    // $link = strtolower($link);
                                      ...
                                      if($k <= 7){
                                       ...
                                       <li><a title="<?php echo $cate->LinkTitleTag; ?>" href="<?php echo $cate->URL; ?>"><?php echo $cate->MenuName; ?></a></li>
                                       <?php
                                     }
...
<!--                                             <li id="menu-item-246" class="ubermenu-item ubermenu-item-type-custom ubermenu-item-object-custom ubermenu-item-246 ubermenu-item-auto ubermenu-item-header ubermenu-item-level-5 ubermenu-column ubermenu-column-1-4"><span class="ubermenu-target ubermenu-target-with-image ubermenu-item-layout-default ubermenu-item-layout-image_left ubermenu-item-notext">
  ...
  <li id="menu-item-233" class="FiFTYFIFTY Seventy">
    <a class="blue_clor pandg" >
      <span class="ubermenu-target-title ubermenu-target-text ">Shop By Category</span>
    </a>
    <ul class="ubermenu-submenu ubermenu-submenu-id-189 ubermenu-submenu-type-auto ubermenu-submenu-type-stack FIFTy_WTH mega_Custom">
...
<li id="menu-item-232" class="FiFTYFIFTY thirty">
  <a class="blue_clor mystyle" >
    <span class="ubermenu-target-title ubermenu-target-text ">Shop by Brand</span>
  </a>
  ...
  <ul class="ubermenu-tab-content-panel ubermenu-column ubermenu-column-4-5 ubermenu-submenu ubermenu-submenu-id-184 ubermenu-submenu-type-auto ubermenu-submenu-type-tab-content-panel">
    ...
    <li class="toptotp_right ">
      ...
      <ul class="menu_Social_icn">
        <li class="TWENTYFIVEWTH"><a href="https://www.amazon.com/s?me=A1WS6H6YCF2VJ&merchant=A1WS6H6YCF2VJ&qid=1507581575"><img src="<?php echo base_url('public/assets/images/a_ICON.png'); ?>" alt="amazonimage"/></a></li>

        <li class="TWENTYFIVEWTH"><a href="https://facebook.com/globalfitness"><img src="<?php echo base_url('public/assets/images/facebook_ICON.png'); ?>" alt="facebookimage"/></a></li>

        <li class="TWENTYFIVEWTH"><a href="https://plus.google.com/+Globalfitnessinc"><img src="<?php echo base_url('public/assets/images/g_ICON.png'); ?>" alt="googleimage"/></a></li>

        <li class="TWENTYFIVEWTH"><a href="https://instagram.com/globalfitnessinc/"><img src="<?php echo base_url('public/assets/images/w_ICON.png'); ?>" alt="instagram"/></a></li>

        <li class="TWENTYFIVEWTH"><a href="https://www.linkedin.com/company/globalfitness.us.com"><img src="<?php echo base_url('public/assets/images/in_ICON.png'); ?>" alt="linkedin"/></a></li>

        <li class="TWENTYFIVEWTH"><a href="https://pinterest.com/globalfitnessla/"><img src="<?php echo base_url('public/assets/images/p_ICON.png'); ?>" alt="pinterest"/></a></li>

        <li class="TWENTYFIVEWTH"><a href="https://twitter.com/globalfitness96"><img src="<?php echo base_url('public/assets/images/t_ICON.png'); ?>" alt="twitter"/></a></li>

        <li class="TWENTYFIVEWTH"><a href="https://youtube.com/user/GlobalFitnessDotCom"><img src="<?php echo base_url('public/assets/images/y_ICON.png'); ?>" alt="youtube"/></a></li>
      </ul>
    </li>
  </ul>
...
<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8 col-sm-offset-2 col-lg-offset-2 col-md-offset-2 top_hder_SINGLE_LINK PADD_ThREee"><!-- coltwo -->
