...
<li><a href="<?php echo base_url('/gym-accessories/vibration-platform'); ?>/">Vibration Platforms</a></li>
                                  ...
                                  <li class="toptotp_right ">
                                    ...
                                    <ul class="menu_Social_icn">
                                      ...
                                      <li class="TWENTYFIVEWTH"><a href="https://linkedin.com/company/globalfitness.us.com"><img src="<?php echo base_url('public/assets/images/in_ICON.png'); ?>" alt="linkedin"/></a></li>
