...
<div class="container">
  ...
  <div class="row chackout_penal">
    <div class="col-md-3 col-sm-3 col-xs-4">
      <div class="cart_product_img"><img src="<?php echo base_url('public/assets/images/chackout_product_img.png'); ?>" alt="product image"/></div>
    </div><!--end colm-->
		...
		<div class="col-md-6 col-sm-6 col-xs-6">
			<div class="row recomnd">
				<div class="col-md-4 col-sm-4 textcenter">
					<a href=""><img src="<?php echo base_url('public/assets/images/chack_out_img.png'); ?>" alt="checkout image"/></a>
				</div>
