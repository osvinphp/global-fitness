					...
					if($_SESSION['shipping']['home']=="0"){
						...
						?>
						   ...
						   <div class="joint_one">
								...
								<b>$625.00 White Glove Delivery</b>
										...
										<div class="shipping_form_penal">
								    		...
								    		<div class="fourth_penal_ship">
								    			...
								    			<div class="fifth_penal_ship" >
                                                    ...
                                                    <div class="loder_zip_file"><img style="display:none" id="loader" src="<?php echo base_url(); ?>/public/assets/images/ajax-loader.gif" alt="loader"></div>
													</div>
							    	...
							    	<div class="shipping_title">Payment Method</div>
								    	<div class="payment_chack_prop">
								    		...
								    		<div class="payment_metod_img">
								    		   <img src="<?php echo base_url('public/assets/images/payment_method_img.png'); ?>" alt="payment_method"/>
								    		</div>
								    	</div>
						    	  ...
						    	  <div class="payment_chack_prop_bottom">
						    		...
						    		<p class="color_blue">Wire & COD Instructions</p>
										...
										<?php
											// if($_SESSION['shipping']['home']=="0"){
											// 	$totalprice+=300;
											// 	echo "<div class='shipping_title'><b>$625.00 White Glove Delivery<br></b></div>";
											// }
										?>
