	...
	<div class="container">
		...
		<div class="row chack_out_one">
            ...
            <div class="col-md-9 col-sm-8 col-xs-4">
		      <div class="cart_product_img"><img src="http://www.de-roquefeuil-labistour.com/public/assets/images/chackout_product_img.png" alt="product image"></div>
		      <h4 class="chackpro_name web_view"><span>1.</span>Life Fitness Insignis Series Treadmill</h4>
		    </div>


			<div class="col-md-3 col-sm-4 col-xs-8">
			<h4 class="chackpro_name responsiv"><span>1.</span>Life Fitness Insignis Series Treadmill</h4>
			...
			<div class="joint_penal_group">
			   ...
			   <div class="joint_one">
					<div class="parice_check red_color">Text</div>
					<div class="parice_check_total red_color">0.00</div>
			   </div>
		...
		<div class="row chack_out_one_accordian">
			<div class="col-md-12 col-sm-12">
					<ul id="accordion" class="accordion">
					  <li>
					    <div class="link"><span>1</span> Shipping Details</div>
						    <ul class="submenu">
						    	<div class="row">
					  ...
					  <li>
					    <div class="link"><span>2</span> Payment Details</div>
						    <ul class="submenu">
						    	<div class="row">
								    <div class="col-md-6 col-sm-6">
								    	<div class="shipping_chack_out">
								    ...
								    <div class="col-md-6 col-sm-6 padd_lot">
								    	...
								    	<div class="payment_chack_prop">
								    		...
								    		<div class="payment_metod_img">
								    		   <img src="<?php echo base_url('public/assets/images/payment_method_img.png'); ?>" alt="payment method"/>
								    		</div>
								    	</div>
					  ...
					  <li>
					    <div class="link"><span>3</span> Account</div>
						    <ul class="submenu">
...
<!-- 	<div class="chack_out_question">
		   <dt>
		    <a class="accordion-title accordionTitle js-accordionTrigger is-collapsed is-expanded" aria-controls="product2" aria-expanded="true" href="#question2">
		      Do you offer free shipping in the LA basin?<div class="arrw"><span class="bar top"></span><span class="bar bottom"></span></div></a>
		    </dt>
		    <dd aria-hidden="false" id="question2" class="accordion-content accordionItem is-expanded animateIn">
		        <div class="accordian_inner_con">
						<div class="Ouestion_penal_left">	
							<p>More often than not we can offer free delivery in the Los Angeles area, however this would need to be arranged and accounted for at the time of sale or you can contact your sales representative for offers and restrictions on free local deliveries.</p>
						</div>
