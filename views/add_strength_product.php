          ...
          <div class="panel-body">
            <form class="form-horizontal" method="post" enctype="multipart/form-data" action="" role="form" >
              ...
              <div class="form-group">
                  ...
                  <div class="col-lg-10">
                    <input required placeholder="e.x. 72 (enter only the number no special characters ) *Max of 5 Numbers" type="text" class="form-control" id="inputPassword1" name="DimLength" >
                  </div>
              </div>
              ...
              <div class="form-group">
                  ...
                  <div class="col-lg-10">
                      <input required placeholder="e.x. 52 (enter only the number no special characters ) *Max of 5 Numbers" type="text" class="form-control" id="inputPassword1" name="DimWidth" >
                  </div>
              </div>
              ...
              <div class="form-group">
                  ...
                  <div class="col-lg-10">
                      <input placeholder="e.x. 22 (enter only the number no special characters ) *Max of 5 Numbers" required type="text" class="form-control" id="inputPassword1" name="DimHeight" >
                  </div>
              </div>
              ...
              <div class="form-group">
                  ...
                  <div class="col-lg-10">
                      <input required placeholder="e.x. 350 (enter only the number no special characters ) *Max of 5 Numbers"  type="text" class="form-control" id="inputPassword1" name="Weight" >
                  </div>
              </div>
              ...
              <div class="form-group">
                  ...
                  <div class="col-lg-10">
                      <input required placeholder="e.x. 350 (enter only the number no special characters ) *Max of 5 Numbers"  type="text" class="form-control" id="inputPassword1" name="ShippingWeight" >
                  </div>
              </div>
              ...
              <div class="form-group">
                  ...
                  <div class="col-lg-10">
                      <input required placeholder=" e.x. 325 (enter only the number no special characters or Undiscolsed) *Max of 10 Numbers" type="text" class="form-control" id="inputPassword1" name="WeightStackCapacity" >
                  </div>
              </div>
              <div class="form-group">
