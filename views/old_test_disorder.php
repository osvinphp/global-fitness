 ...
 if($detail[0]->QuantityOnHand<=0){
                  ...
                  <?php }else
                    ...
                    <?php if($detail[0]->CategoryName =='Selectorized Station' || $detail[0]->CategoryName =='Plate Loaded Station'){
                      ?>
                        <a  data-toggle="modal" data-target="#myModal_important_notice" class="btn drop_ad " title="Click here to add this <?php echo $detail[0]->ProductName; ?> to your shopping cart" >Add To Cart</a>
                      <?php 
                      } else{?>
                  <a   class="btn drop_ad " title="Click here to add this <?php echo $detail[0]->ProductName; ?> to your shopping cart" href="<?php echo base_url('site/addcart').'/'.$detail[0]->ListID ; ?>" id="addcart" >Add To Cart</a>
                  <?php
                }
                   }
