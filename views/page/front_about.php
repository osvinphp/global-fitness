...
<div class="row PADD_ThREee" id="contact_PAGE_Id" >
	<div class="col-md-12 col-sm-12">
		<h1 class="GET_intouch">Contact Global Fitness | Get in Touch</h1>
	</div>
</div>
	...
	<div class="col-md-12 col-sm-12 col-xs-12 ppppd">
		<div class="social_cont_PENl text-center" > 
			<ul class="social_cont">
				<li class="TWENTYWTH"><a href="https://www.amazon.com/s?me=A1WS6H6YCF2VJ&merchant=A1WS6H6YCF2VJ&qid=1507581575"><img src="<?php echo base_url() ?>/public/assets/images/AMAZON_cONT_ICN.png" alt="amazon"></a></li>
				<li class="TWENTYWTH"><a href="https://facebook.com/globalfitness"><img src="<?php echo base_url() ?>public/assets/images/FB_cONT_ICN.png" alt="facebook"></a></li>
				<li class="TWENTYWTH"><a href="https://plus.google.com/+Globalfitnessinc"><img src="<?php echo base_url() ?>/public/assets/images/gPLUSH_cONT_ICN.png" alt="google"></a></li>
				<li class="TWENTYWTH"><a href="https://instagram.com/globalfitnessinc/"><img src="<?php echo base_url() ?>/public/assets/images/INSTA_cONT_ICN.png" alt="instagram"></a></li>
				<li class="TWENTYWTH"><a href="https://www.linkedin.com/company/globalfitness.us.com"><img src="<?php echo base_url() ?>/public/assets/images/LINKIN_cONT_ICN.png" alt="linkedIn"></a></li>
				<li class="TWENTYWTH"><a href="https://pinterest.com/globalfitnessla/"><img src="<?php echo base_url() ?>/public/assets/images/PINTRST_cONT_ICN.png" alt="pinterest"></a></li>
				<li class="TWENTYWTH"><a href="https://twitter.com/globalfitness96"><img src="<?php echo base_url() ?>/public/assets/images/TEITTER_cONT_ICN.png" alt="twitter"></a></li>
				<li class="TWENTYWTH"><a href="https://youtube.com/user/GlobalFitnessDotCom"><img src="<?php echo base_url() ?>/public/assets/images/YOUTUB_cONT_ICN.png" alt="youtube"></a></li>
			</ul>
		</li>
	</div>
</div>
