...
if($title == 'Contact Global Fitness Equipment | Call Global Fitness and Save'){
    // print_r($title);
?>
...
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3311.512911835987!2d-118.30856968442005!3d33.902196433068966!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x80c2b58ec12cdbf5%3A0x1186bd328b160ae7!2sGlobalfitness%C2%AE+Fitness+Equipment!5e0!3m2!1sen!2sin!4v1485496623383" width="100%" height="300" frameborder="0" style="border:0" allowfullscreen></iframe>
        ...
        <div class="row PADD_ThREee" id="contact_PAGE_Id" >
            <div class="col-md-12 col-sm-12">
                <h2 class="GET_intouch">Contact Global Fitness | Get in Touch</h2>
            </div>
        </div>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12 ppppd">
            	<div class="social_cont_PENl text-center" >                    
                    <ul class="social_cont">
                      <li class="TWENTYWTH"><a href="https://www.amazon.com/s?me=A1WS6H6YCF2VJ&merchant=A1WS6H6YCF2VJ&qid=1507581575"><img src="<?php echo base_url() ?>/public/assets/images/AMAZON_cONT_ICN.png" alt=""></a></li>
                      <li class="TWENTYWTH"><a href="https://www.facebook.com/globalfitness"><img src="<?php echo base_url() ?>public/assets/images/FB_cONT_ICN.png" alt=""></a></li>
                      <li class="TWENTYWTH"><a href="https://plus.google.com/+Globalfitnessinc"><img src="<?php echo base_url() ?>/public/assets/images/gPLUSH_cONT_ICN.png" alt=""></a></li>
                      <li class="TWENTYWTH"><a href="https://instagram.com/globalfitnessinc/"><img src="<?php echo base_url() ?>/public/assets/images/INSTA_cONT_ICN.png" alt=""></a></li>
                      <li class="TWENTYWTH"><a href="https://www.linkedin.com/company/globalfitness.us.com"><img src="<?php echo base_url() ?>/public/assets/images/LINKIN_cONT_ICN.png" alt=""></a></li>
                      <li class="TWENTYWTH"><a href="https://pinterest.com/globalfitnessla/"><img src="<?php echo base_url() ?>/public/assets/images/PINTRST_cONT_ICN.png" alt=""></a></li>
                      <li class="TWENTYWTH"><a href="https://twitter.com/globalfitness96"><img src="<?php echo base_url() ?>/public/assets/images/TEITTER_cONT_ICN.png" alt=""></a></li>
                      <li class="TWENTYWTH"><a href="https://youtube.com/user/GlobalFitnessDotCom"><img src="<?php echo base_url() ?>/public/assets/images/YOUTUB_cONT_ICN.png" alt=""></a></li>
                    </ul>
                  </li>
            	</div>
            </div>
