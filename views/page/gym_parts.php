                                        ...
                                        <td class="blank">
                                            <?php
                                                ...
                                                if( in_array($live->PartName , $_SESSION['mylistproducting']['listname']) )
                                                  {
                                                    ?>
                                                <img class="likeImageS" alt="cart" src="<?php echo base_url('public/assets/images/check_img.png'); ?>" data-status="1" data-name="<?php  echo $live->PartName;  ?>" data-src="<?php echo base_url('public/assets/images/plush_cart.png'); ?>">
                                                <?php
                                                      }
                                                      else{
                                                        ?>
                                                <img class="likeImageS" alt="cart" data-src="<?php echo base_url('public/assets/images/check_img.png'); ?>" data-status="0" data-name="<?php  echo $live->PartName;  ?>" src="<?php echo base_url('public/assets/images/plush_cart.png'); ?>">
                                                <?php
                                                          }
                                                       ?>
              ...
              <div class="product_penal__question">
               ...
               <div class="question_heding">
                ...
                if( in_array($live->PartName , $_SESSION['mylistproducting']['listname']) )
                  ...
                  {
                    ?>
                    <img class="likeImageS" alt="cart" data-src="<?php echo base_url('public/assets/images/check_img.png'); ?>" data-status="0" data-name="<?php  echo $live->PartName;  ?>" src="<?php echo base_url('public/assets/images/plush_cart.png'); ?>">  <?php
                  }
