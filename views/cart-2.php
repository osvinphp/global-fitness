...
<?php
   for($i=0; $i<$_SESSION['productDetail']['count'];$i++){
    ...
    <input type='hidden' name='return' value='<?php echo base_url('/index.php/site/success') ; ?>'>
           ...
           <img alt="pixel" border="0" src="https://www.paypal.com/en_AU/i/scr/pixel.gif" width="1" height="1">
            </form>
              <?php }else{ 
                ?>
...
<div class="container">
  ...
  <div class="row chackout_penal">
    <div class="col-md-3 col-sm-3 col-xs-4">
      <div class="cart_product_img"><img src="<?php echo base_url('public/assets/images/chackout_product_img.png'); ?>" alt="product"/></div>
    </div><!--end colm-->
    ...
    <div class="col-md-6 col-sm-6 col-xs-6">
      <div class="row recomnd">
        <div class="col-md-4 col-sm-4 textcenter">
          <a href=""><img src="<?php echo base_url('public/assets/images/chack_out_img.png'); ?>" alt="checkout"/></a>
        </div>
