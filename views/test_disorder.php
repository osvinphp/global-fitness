                ...
                <div class="top_brder">
                  <div class="padd-no">
                    <dt class="respon all_center">
                        <h1 aria-expanded="false" aria-controls="accordion1" class="accordion-title accordionTitle js-accordionTrigger  ACCORDIan_H_ONE"  href="#accordion1"> <span itemprop="brand" style="display: none"></span><span itemprop="name"><?php echo $detail[0]->ProductName ; ?> </span>
...
<button class="btn btn-default Emailwala" data-toggle="modal" data-target="#myModal_email">Email me</button>
<?php }else{ 
...
<div class="tab-content">
  <div id="home" class="tab-pane fade in active">      <?php
        if(count($review)>0){
