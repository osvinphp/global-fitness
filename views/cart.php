...
<div class="containercrt">
 ...
 <form class="PADD_ThREee1" action="" method="post">
  <?php
       $rk = 1;
       $rs = 1;
       $rss = 10;
                ...
                <div class="col9">
                  ...
                  <div class="row chack_out_product_content">
                    ...
                    <?php if($live->KingdomContingent=="Cardio"){ ?>
                        <a href="<?php echo base_url('cardio').'/'.$link; ?>"><?php echo $live->Name; ?></a>
                        <?php
                      }
                      else
                      {
                        ?>
                        <a href="<?php echo base_url('strength').'/'.$link; ?>"><?php echo $live->Name; ?></a>
                        <?php
                      }
                    ?>
                    </h4></div>
                  ...
                  <div class="row chack_out_product_content_bottom">
                    ...
                    <div class="line_res">
                      <h4 class="deleat_from_chart"><a rel =" "  href="<?php echo base_url('/site/deleting'); ?>/<?php echo ($rs-1); ?>">Delete From Cart</a></h4>                      </div>
                  </div>
                 </div>
                </div>
              </div>
        ...
        foreach($product as $live){
          ...
          ?>
             <div class="row chackout_penal">
                ...
                <div class="col9">
                  <div class="row chack_out_product_content RRR">
                    <div class="col6 padd_no_web"><h4>
                    <?php if($live->Kingdom=="Cardio"){ ?>
                        <a rel =" " href="<?php echo base_url('/cardio').'/'.$link; ?>"><?php echo $live->ProductName; ?></a>
                        <?php
                      }
                      else
                      {
                        ?>
                        <a  rel =" "  href="<?php echo base_url('/strength').'/'.$link; ?>"><?php echo $live->ProductName; ?></a>
                        <?php
                      }
                    ?>
                    </h4></div>
                    <div class="col6 padd_no_web">
                    <div class="parice_check" ><?php echo $live->Price;   ?>
                  ...
                  <div class="row chack_out_product_content_bottom RRR">
                    <div class="col6 padd_no_web">
                  ...
                  <div class="col6 padd_no_web">
                    <div class="line_res">
                      <h4 class="deleat_from_chart"><a rel =" "  href="<?php echo base_url('/site/delete'); ?>/<?php echo $_SESSION['productDetail']['addtocart'][$i]; ?>">Delete From Cart</a></h4>
                   </div>
                  </div>
                 </div>
                </div>
    ...
    <div class="col-md-12 col-sm-12 chackout_penal_bottom1">
        ...
        ?>
          <div class="col-md-8 col-sm-7 padd_no_web">
              <div class="continue_button"><a rel =" "  href="<?php echo base_url('fitness-equipment/used-treadmills'); ?>">Continue Shopping</a></div>
              <div class="chat_and_chack_responsive">
            <div class="chat"><a rel =" "  href="">Chat Now</a></div>
          </div>
          </div>
          ...
          <div class="chat_and_chack">
            <div class="chat"><a rel =" "  href="">Chat</a></div>
          ...
          <div class="continue_button_responsive"><a rel =" " href="<?php echo base_url('fitness-equipment/used-treadmills'); ?>">Continue Shopping</a></div>
        </div>
        <?php
          }
          else
              ...
              <a  rel =" "  data-toggle="modal" <?php
                ...
                if($products->IsWarranty ==1){
                 echo base_url('/public/assets/images/warranty_img_bottom.png');}else{
                  ...
                  ?>" alt="<?php echo $link2; ?>"/></a>
              </div>
              <div class="col-md-8 col-sm-8">
                <h4><a rel =" "  data-toggle="modal"
                <?php
                if($products->IsWarranty ==1){
                  echo "data-target='#myModal_Warrenty".$t."'";
                }else{
                        ...
                        <div class="box">
                            <div class="row inner_product_discription ">
                                <div class="col-md-6 col-sm-6 img_penal_l all_center">
                                    <img alt="warranty" src="<?php echo base_url() ?>/public/assets/images/warranty_img.png">
                                </div>
                                <div class="col-md-6 col-sm-6 all_center BOddr">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <div class="dropdown ">
                                             <a rel =" "  class="btn drop_ad " title="Click here to add this <?php echo $products->ProductName; ?> to your shopping cart" href="<?php echo base_url('/site/addingtocart').'/'.$products->ListID.'/'.$my ; ?>" id="addcart">Add To Cart</a>
                                        </div>
                                    </div>
                                    <div class="row">
                                            ...
                                            <div class="product_penal_content">
                                                ...
                                                <div class="product_penal__question">
                                                    <div class="question_heding">
                                                        <img alt ="question" src="<?php echo base_url('public/assets/images/renameq.jpg'); ?>">Have Questions?
                                                    </div>
                                                    <ul class="product_penal__question_boxX">
                                                        <li>
                                                            ...
                                                            <a rel =" "  data-toggle="modal" title="Click to chat about this <?php echo $detail[0]->ProductName; ?>" data-target="" class="btn btn-link" href="#">Live Chat</a>
                                                            <br>
                                                            <a rel =" "  data-toggle="modal" title="Click here to contact Global Fitness about this <?php echo $detail[0]->ProductName; ?>" data-target="#emailUs" class="btn btn-link" href="#">Email Us</a>
                                                            <br>
                                                            <a rel =" "  data-toggle="modal" title="Click here to request a call and discuss this <?php echo $detail[0]->ProductName; ?>" data-target="#requestacall" class="btn btn-link" href="#">Click to Call</a>
                                                        </li>
                                                    </ul>
                                                </div>
                ...
                <div class="paddingg">
                    ...
                    <div class="modal-body">
                        <div class="box">
                            <div class="row inner_product_discription ">
                                <div class="col-md-6 col-sm-6 img_penal_l all_center">
                                    <img alt="products" src="<?php echo base_url() ?>/<?php echo $products->Expr1; ?>">
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12 all_center">
                                            ...
                                            <div class="product_penal_content">
                                                ...
                                                <div class="product_penal__question">
                                                    <div class="question_heding">
                                                        <img alt="questions" src="<?php echo base_url('public/assets/images/renameq.jpg'); ?>">Have Questions?
                                                    </div>
                                                    <ul class="product_penal__question_boxX">
                                                        <li>
                                                            <span style="color:#f00">
