    ...
    <div class="row MG_BOTM">
      <div class="col-md-6 col-sm-6 col-xs-12 text-center1">
        <?php  if(isset($slideImages)){
                        // echo "<pre>";print_r($slideImages);die;
          ?>
          <div id='carousel-custom' class='carousel slide' data-ride='carousel'>
            <div class='carousel-outer'>
              ...
              <!-- sag sol -->
                    ...
                    <!-- <div class="Prod_detail_IMg Probodr">
                        <img class="img-responsive" alt="<?php echo base_url($detail[0]->ImageAtl); ?>" title="<?php echo base_url($detail[0]->ImageTitle); ?>" src="<?php echo base_url($detail[0]->ImageURL); ?>">
                      </div> -->
                    <!-- <div class="multy_img_slide">
                        <ul class="multy_img_slide_list">
                            <li class="active">
                                <a href="">
                      <img class="img-responsive" alt="" title="" src="<?php echo base_url('public/assets/images/product_img_icon.png'); ?>">
                    </a>
                            </li>
                            <li>
                                <a href="">
                                  ...
                                  <div class="product_penal_content">
                                    ...
                                    <div class="new_product_penal_shiping all_center">
                                      <div class="ALL_CONTENT_right_box">
                                        ...
                                        <!-- <div class="new_product_penal_shiping_right all_center">
                                    ...
                                    <div class="ALL_CONTENT_right_box">
                                      ...
                                      <!-- <div class="new_product_penal_shiping_right all_center"></div> -->
                                    </div>
                                    <div class="ALL_CONTENT_right_box">
                                      <div class="new_product_penal_shiping_left all_center">MPN: <span itemprop="mpn" ><?php  echo $detail[0]->MPN; ?></span></div>
                                      <!-- <div class="new_product_penal_shiping_right all_center">CLST</div> -->
                        ...
                        <div class="row SECtion_new_prod">
                          <div class="col-md-12 col-sm-12 col-xs-12">
                             <div class="prod_tittlt" id="<?php echo $ConditionAnchorHrefName; ?>">
                              ...
                              <div class="new_prod_paragraph">
                                <!-- <p>Are you interested in customizing your gym equipment? Global Fitness can customize this refurbished Life Fitness CLST treadmill to match your sports team or corporate colors. Past clients include Under Armor, Facebook and several NFL teams. </p>
                                <p>View some of our <a href="" title="">cutom gym equipment</a> in our online gallery.</p> -->
...
<!-- <div class="row SECtion_new_prod">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="prod_tittlt" id="<?php //echo $ConditionAnchorHrefName; ?>">
            <h2>Description of Condition: <?php //echo $detail[0]->ConditionCategory; ?></h2>
        </div>
        <div class="new_prod_paragraph">
           <p>Prior to shipping the machines are put through a 42-point inspection, and then stripped down to the bare frame. Frames are powder-coated to perfection, new parts replace the worn, and the machine is brought back to “like new” condition. The machine undergoes a full quality control inspection, placed under stress testing, and once they pass, sent to our packaging department to be professionally packaged and prepared for shipping.Want more details?
            <a class="new_prod_paragraph_link" href="#<?php //echo strip_tags($detail[0]->ProductionDetailsTitle); ?>" title="<?php //echo strip_tags($detail[0]->ProductionDetailsTitle); ?>">Read production Details</a></p>
       </div>
   </div>
   <!--end colm-->
   <!--</div> -->
   <!--end row-->
                       <div class="row SECtion_new_prod">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                          ...
                          <div class="new_prod_paragraph new_ligt_color"><span itemprop="description">
                                          <?php echo $detail[0]->ProductDescription; ?> <!--  <p class="new_ligt_color">The refurbished Life Fitness CLST treadmill is one of the best selling treadmills in 2016 and 2017. The Life Fitness CLST treadmill workouts are integrated into a contemporary industrial design with high-performing durability and a simple, non-intimidating console. This familiar, trusted treadmill is used today by thousands of world-class gym and fitness facilities all over the globe, and with good reason, it delivers.</p>
                                            <p class="new_ligt_color">Furthermore, at 431 pounds, the refurbished Life Fitness CLST treadmill boasts 28 workouts on a 20 inch waxless treadmill belt and deck that can support up to 400 pounds. The treadmill is also equipped with a 4 horse power continuous duty motor that reaches speeds of 14 mile per hour up to a 15 percent incline. The treadmill also comes equipped with the Lifepulse Digital Contact Hear Rate system and is also Polar Compatible.</p>
                                            <p class="new_ligt_color">Finally, your purchase is covered by a 1 year all-encompassing warranty that protects all aspects of the treadmill other than negligent use, malicious damage or force majeure. The only exclusions are the wear parts. The warranty includes labor, and we will locate and assign a fitness technician to conduct the necessary repair work on the machine. All parts replaced are OEM and typically new. This is by far the best warranty in the industry exceeding all standards.</p> -->
                                          </span></div>
                                        </div><!--end colm-->
                                      </div><!--end row SECtion_new_prod-->
           ...
           <!--              <div class="prod_tittlt">
                        ...
                        <p>The limited warranty on the Used Life Fitness CLST Integrity Series Treadmill covers defective motors, alternators,  or complete failure within the first 30 days. In addition, your used treadmill  warranty covers excessive grinding and abrasive noises. The warranty is also strictly a parts only warranty. Global Fitness assigns a local service technician and either new or used OEM or generic parts to repair the issue.</p>
                        <div class="prod_tittlt">
                            <h3>What is Not Covered?</h3>
                        </div>
                        <p>The limited warranty on the Used Life Fitness CLST Integrity Series Treadmill does not cover the labor for the assigned service technician. Also, the used treadmill warranty does not cover LCD TV screens nor electronics failures.</p> -->
                      </div>
                    </div><!--end colm-->
                  </div><!--end row-->
                  <?php if(!empty($video)){ ?>
